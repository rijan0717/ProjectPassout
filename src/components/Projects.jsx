...
const projects = [
  {
    ...
    description: "Full-featured library system with book tracking, member management, and fine calculation. Built with PHP & MySQL.",
    tags: ["PHP", "MySQL", "Bootstrap"],
    category: "BCA",
  },
  {
    title: "Online Voting System",
    description: "Secure e-voting platform with OTP verification, real-time results, and admin panel. Built with React & Node.js.",
    tags: ["React", "Node.js", "MongoDB"],
    category: "BIT",
  },
  {
    title: "Hospital Management System",
    description: "Patient records, appointment scheduling, and billing system for small clinics. Built with Java & SQL.",
    tags: ["Java", "SQL", "Swing"],
    category: "BCA",
  },
  {
    title: "E-Commerce Website",
    description: "Complete shopping platform with cart, payment gateway, and admin dashboard. Built with Laravel.",
      ...
      <div style={{
        ...
        {projects.map((project, i) => (
          ...
          >
            ...
            <h3 style={{ fontSize: "1.1rem", fontWeight: 700, margin: "14px 0 10px" }}>
              {project.title}
            </h3>
            <p style={{ color: "#888", fontSize: "0.9rem", lineHeight: 1.65, marginBottom: "18px" }}>
              {project.description}
            </p>
